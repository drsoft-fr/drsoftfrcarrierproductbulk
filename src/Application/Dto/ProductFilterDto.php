...
final class ProductFilterDto
{
    ...
    public ?float $depthMin = null;
    public ?float $depthMax = null;
    ...
    public function __construct(array $data)
    {
        ...
        $this->widthMin = $this->initializeFloatValue($data, 'widthMin');
        $this->widthMax = $this->initializeFloatValue($data, 'widthMax');
        $this->heightMin = $this->initializeFloatValue($data, 'heightMin');
        $this->heightMax = $this->initializeFloatValue($data, 'heightMax');
        $this->depthMin = $this->initializeFloatValue($data, 'depthMin');
        $this->depthMax = $this->initializeFloatValue($data, 'depthMax');
